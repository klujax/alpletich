-- =============================================
-- FIX DATABASE SCHEMA - MISSING TABLES
-- Run this script in the Supabase SQL Editor to create all missing tables if they don't exist.
-- =============================================

-- DROP tables if they exist to ensure consistent state
DROP TABLE IF EXISTS public.class_enrollments CASCADE;
DROP TABLE IF EXISTS public.purchases CASCADE;
DROP TABLE IF EXISTS public.reviews CASCADE;
DROP TABLE IF EXISTS public.group_classes CASCADE;
DROP TABLE IF EXISTS public.gym_stores CASCADE;
...
-- Only add if not exists, but simpler to just try adding or updating
