...
export default function NutritionPage() {
    return (
        <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-fade-in">
            ...
            <h1 className="text-2xl font-black text-slate-900 mb-2">Beslenme Planları</h1>
            <p className="text-slate-500 font-medium max-w-md mb-8">
                Bu özellik yakında paketlerinizin içine entegre edilecek. Şimdilik paketlerinize beslenme planı ekleyebilirsiniz.
            </p>
